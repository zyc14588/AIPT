...
function panel(documentLike: DocumentLike, title: string, rows: readonly [string, string][]): ElementLike {
  const article = element(documentLike, 'article', 'panel', '');
