...
// The report schema and task_id are B004 (AIPT-M0-B004 construction
// IN_PROGRESS): the report is an under-construction validator run, never a
// merge/closeout claim. Every pre-B004 validator is retained alongside the
// B004 runtime-shell gate.
