...
1. **机器登记（Machine Registry）**——决策 ID、选择、状态与覆盖关系的**机器权威**：
   ...
   - [registry/unregistered-aipt-p1-b000-authority-amendment-001.json](registry/unregistered-aipt-p1-b000-authority-amendment-001.json)：在不修改上述冻结 Authority 的前提下，追加授权 validator identity supersession、B001 historical CLOSED-state repair 与 exact-target post-merge reverification；只有按序且已接受的 Amendment/supersession record 才进入 effective Authority。
